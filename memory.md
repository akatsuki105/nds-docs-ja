...
```
  0000_0000h  ITCM (32KB) (1000000hごとにミラー)
...
共有WRAMは`300_0000h`から始まりますが、プログラムでは（ARM9、ARM7とも）ミラーされている`37F_8000h`を使うのが一般的です。これにより、ARM7側では、32KBの共有WRAM と 64KBのARM7-WRAM を96KBの連続したRAMブロックとして使用することができます。
