...
bit0-1を`0b11`にしてARM9にSWRAMを割り当てなかった場合、SWRAMは未定義状態になります。bit0-1を`0b00`にしてARM7にSWRAMを割り当てなかった場合、SWRAMのメモリ空間(`0x0300_0000..037F_FFFF`)は、`0x0380_0000..03FF_FFFF`(ARM7専用のWRAM)のミラーになります。
