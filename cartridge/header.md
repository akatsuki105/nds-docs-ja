...
```
  ...
  08Ch    36    Reserved (zero filled; except, [88h..93h] used on DSi)
  0B0h    16    Reserved (zero filled; or "DoNotZeroFillMem"=unlaunch fastboot)
  0C0h    156   Nintendo Logo (compressed bitmap, same as in GBA Headers)
  ...
  170h    144   Reserved (zero filled) (transferred, but not stored in RAM)
```
