...
他にも、ジオメトリコマンドでポリゴンと頂点にアトリビュートを割り当てることができ、これには頂点カラーまたは自動的に計算されるライトカラー、テクスチャ属性、ポリゴンあたりの頂点数（3個または4個）、および多数のフラグが含まれ、これらのアトリビュートはポリゴンRAMに格納されます。ポリゴンRAMには、頂点RAMの対応する頂点へのポインタも含まれます。
