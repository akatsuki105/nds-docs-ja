...
GBAスロットはEXMEMCNT.7を通して、ARM9かARM7に対してマッピングされます。

マッピングされたCPUにとって、`0x0800_0000-0x09FF_FFFF`のメモリが`GBA ROM`領域、`0x0A00_0000-0x0AFF_FFFF`のメモリが`GBA SRAM`領域となります（64KBごとに繰り返されます）。
